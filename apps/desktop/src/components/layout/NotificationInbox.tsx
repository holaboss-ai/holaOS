  ...
  return (
    <Popover open={open} onOpenChange={onOpenChange}>
      ...
      <PopoverContent
        ...
        side="bottom"
        sideOffset={8}
        // Pin the side and shift (never flip) horizontally so the panel
        // can't oscillate between left/right alignments near the viewport
        // edge while the layout reflows (e.g. during a pane resize).
        collisionAvoidance={{
          side: "none",
          align: "shift",
