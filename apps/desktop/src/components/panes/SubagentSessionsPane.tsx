      ...
      <div className="shrink-0 px-4 pt-3 pb-2">
        <div className="relative">
          ...
          <input
            ...
            className="h-8 w-full rounded-md border border-border bg-transparent pr-7 pl-7 text-xs text-foreground placeholder:text-muted-foreground focus-visible:border-foreground/20 focus-visible:outline-none"
          />
          {query ? (
            <button
              type="button"
              ...
              onClick={() => setQuery("")}
              className="absolute top-1/2 right-1.5 grid size-5 -translate-y-1/2 place-items-center rounded text-muted-foreground transition-colors hover:bg-foreground/[0.06] hover:text-foreground"
            >
              <X size={11} />
            </button>
          ) : null}
