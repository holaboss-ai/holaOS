...
const HTML_PREVIEW_BRIDGE = [
  ...
  "      return false;",
  "    }",
  // scrollIntoView resolves the offset against whatever actually scrolls
  // (root or nested); the old manual targetRect/scrollRect math
  // double-counted scrollTop on the root scroller, so anchors landed wrong
  // once the page had been scrolled.
