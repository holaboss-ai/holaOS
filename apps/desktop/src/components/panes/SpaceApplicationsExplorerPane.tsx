import { AppWindow, Plus } from "@/components/ui/icons";
...
export function SpaceApplicationsExplorerPane({
  ...
  // provider_id used to come from the marketplace appCatalog; with the
  // marketplace install flow gone, this returns null until installed-app
  // payloads start carrying their own provider_id.
  function lookupProviderId(_appId: string): string | null {
    return null;
  }
