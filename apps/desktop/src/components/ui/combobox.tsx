  ...
  return (
    <Popover open={open} onOpenChange={handleOpenChange}>
      <PopoverTrigger
        ...
        className={cn(
          "inline-flex h-8 w-fit items-center justify-between gap-1.5 rounded-md border border-border bg-card py-1 pr-2 pl-2.5 text-sm font-medium text-foreground whitespace-nowrap select-none shadow-xs transition-colors outline-none hover:bg-fg-2 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/30 disabled:cursor-not-allowed disabled:opacity-50 data-[state=open]:bg-fg-4 [&>svg]:pointer-events-none [&>svg]:shrink-0",
          triggerClassName,
        )}
      >
