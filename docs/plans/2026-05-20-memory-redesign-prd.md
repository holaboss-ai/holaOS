...
- separate durable memory from session continuity state
...
- session continuity state stored nearby
...
Compaction artifacts, checkpoints, and session resume material remain separate runtime concerns and should not be modeled as durable tree leaves.
