...
declare const buttonVariants: (props?: ({
    variant?: "default" | "destructive" | "link" | "secondary" | "outline" | "ghost" | "bordered" | null | undefined;
...
declare function EmptyState({ icon: Icon, title, description, action, size, minHeight, decorated, className, }: EmptyStateProps): react_jsx_runtime.JSX.Element;
...
declare function PopoverContent({ className, positionerClassName, align, alignOffset, side, sideOffset, ...props }: Popover$1.Popup.Props & Pick<Popover$1.Positioner.Props, "align" | "alignOffset" | "side" | "sideOffset"> & {
...
declare function StatusDot({ className, variant, size, withRing, pulse, render, ...props }: StatusDotProps): React.ReactElement<unknown, string | React.JSXElementConstructor<any>>;
...
declare function DashboardShell({ header, children, className, contentClassName, }: DashboardShellProps): react_jsx_runtime.JSX.Element;
...
declare function DataTable<Row>({ columns, rows, rowKey, onRowClick, isLoading, emptyTitle, emptyDescription, className, }: DataTableProps<Row>): react_jsx_runtime.JSX.Element;
...
declare function ErrorState({ title, detail, onRetry, retryLabel, className, }: ErrorStateProps): react_jsx_runtime.JSX.Element;
...
declare function FilterBar({ search, onSearchChange, searchPlaceholder, filters, actions, className, }: FilterBarProps): react_jsx_runtime.JSX.Element;
...
declare function LoadingState({ variant, count, className, }: LoadingStateProps): react_jsx_runtime.JSX.Element;
...
declare function Section({ title, description, actions, children, className, contentClassName, }: SectionProps): react_jsx_runtime.JSX.Element;
...
declare function StatPill({ label, value, icon: Icon, trend, tone, className, }: StatPillProps): react_jsx_runtime.JSX.Element;
