...
async function runIntegrationContextFetchScenario(params) {
  ...
  return {
    ...
    status: "skipped",
    failures: [],
    skip_reason: "integration context fetch scenarios were removed",
    started_at: new Date().toISOString(),
    completed_at: new Date().toISOString(),
    counts_before_scenario: workspaceMemoryCounts(params.dbPath, params.controlPlaneDbPath),
    counts_after_scenario: workspaceMemoryCounts(params.dbPath, params.controlPlaneDbPath),
    integration_reports: [],
    direct_retrievals: [],
    reader_queries: [],
    quality_metrics: {},
