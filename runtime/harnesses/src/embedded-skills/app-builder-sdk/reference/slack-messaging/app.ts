...
//
// For broader Slack coverage (list_channels / search_messages /
// list_users / send_dm), write a new workspace app under
// <workspace>/apps/ that uses this reference as a template plus the
