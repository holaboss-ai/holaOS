...
export interface DesktopBrowserToolServiceLike {
  ...
  listProfiles(context?: DesktopBrowserToolExecutionContext): Promise<Record<string, unknown>>;
  launchProfile(context?: DesktopBrowserToolExecutionContext): Promise<Record<string, unknown>>;
  closeProfile(context?: DesktopBrowserToolExecutionContext): Promise<Record<string, unknown>>;
  execute(
    toolId: string,
...
export class DesktopBrowserToolService implements DesktopBrowserToolServiceLike {
  ...
  async listProfiles(
    ...
    return await this.#browserFetch(config, {
      method: "GET",
      path: "/profiles",
      browserProfileId: context.browserProfileId,
    });
