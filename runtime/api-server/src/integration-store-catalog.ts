...
export interface StoreCatalogEntry {
  ...
  /** Niche / newer / less-recognized toolkits — surfaced with a "beta" badge so
   * users know they're less battle-tested than the mainstream integrations. */
  beta?: boolean;
}
...
const RAW_ENTRIES: StoreCatalogEntry[] = [
  ...
  { slug: "bitbucket", tier: "supported", category: "dev" },
  ...
  { slug: "shortcut", tier: "supported", category: "dev", beta: true },
  { slug: "height", tier: "supported", category: "dev", beta: true },
  { slug: "discord", tier: "supported", category: "comm" },
  { slug: "telegram", tier: "supported", category: "comm" },
  { slug: "whatsapp", tier: "supported", category: "comm" },
  ...
  { slug: "pinecone", tier: "supported", category: "ai_data", beta: true },
  { slug: "firecrawl", tier: "supported", category: "ai_data", beta: true },
  { slug: "exa", tier: "supported", category: "ai_data", beta: true },
  { slug: "perplexityai", tier: "supported", category: "ai_data" },
  { slug: "elevenlabs", tier: "supported", category: "ai_data" },
  ...
  { slug: "kit", tier: "supported", category: "email", beta: true },
  { slug: "sendgrid", tier: "supported", category: "email" },
  { slug: "outlook", tier: "supported", category: "email" },
  { slug: "resend", tier: "supported", category: "email", beta: true },
  { slug: "brevo", tier: "supported", category: "email", beta: true },
  ...
  { slug: "attio", tier: "supported", category: "crm", beta: true },
  ...
  { slug: "google_search_console", tier: "supported", category: "seo" },
  ...
  { slug: "squarespace", tier: "supported", category: "cms" },

  { slug: "canva", tier: "supported", category: "design" },
  { slug: "miro", tier: "supported", category: "design" },

  { slug: "paypal", tier: "supported", category: "commerce" },

  { slug: "tally", tier: "supported", category: "forms", beta: true },
  { slug: "googleforms", tier: "supported", category: "forms" },

  { slug: "calendly", tier: "supported", category: "calendar" },
  { slug: "cal", tier: "supported", category: "calendar", beta: true },

  { slug: "googledocs", tier: "supported", category: "productivity" },
  { slug: "googleslides", tier: "supported", category: "productivity" },
  { slug: "todoist", tier: "supported", category: "productivity" },
